...
<Slide title="Components all the way down" />

<div id="css-zen-garden">
    ...
    <section class="intro" id="zen-intro">
      ...
      <div class="preamble" id="zen-preamble" role="article">
        ...
        <p>
          ...
          browser-specific tags, incompatible <abbr
            title="Document Object Model">DOM</abbr
          >s, broken <abbr title="Cascading Style Sheets">CSS</abbr> support, and
          abandoned browsers.
        </p>
        <p>
          We must clear the mind of the past. Web enlightenment has been
          achieved thanks to the tireless efforts of folk like the <abbr
    ...
    <div class="main supporting" id="zen-supporting" role="main">
      <div class="explanation" id="zen-explanation" role="article">
        ...
        <p>
          There is a continuing need to show the power of <abbr
            title="Cascading Style Sheets">CSS</abbr
          >. The Zen Garden aims to excite, inspire, and encourage
          participation. To begin, view some of the existing designs in the
          list. Clicking on any one will load the style sheet into this very
          page. The <abbr title="HyperText Markup Language">HTML</abbr>
        ...
        <p>
          ...
          illustrated in a way that gets people excited is by demonstrating what
          it can truly be, once the reins are placed in the hands of those able to
          create beauty from structure. Designers and coders alike have contributed
      ...
      <div class="participation" id="zen-participation" role="article">
        ...
        <p>
          ...
          page, so strong <abbr title="Cascading Style Sheets">CSS</abbr>
        ...
        <p>
          ...
          >. This may seem daunting at first if you&#8217;ve never worked this
          way before, but follow the listed links to learn more, and use the
      ...
      <div class="benefits" id="zen-benefits" role="article">
        ...
        <p>
          ...
          all refer to showing people how amazing <abbr
            title="Cascading Style Sheets">CSS</abbr
          > really can be. This site serves as equal parts inspiration for those
          working on the web today, learning tool for those who will be tomorrow,
      ...
      <div class="requirements" id="zen-requirements" role="article">
        ...
        <p>
          ...
          sticking to the guidelines you should see fairly consistent results across
          most modern browsers. Due to the sheer number of user agents on the web
          these days &#8212; especially when you factor in mobile &#8212; pixel-perfect
          layouts may not be possible across every platform. That&#8217;s okay, but
          do test in as many as you can. Your design should work in at least IE9+
          and the latest Chrome, Firefox, iOS and Android browsers (run by over 90%
          of the population).
        </p>
        <p>
        ...
        <p>
          ...
          full copyright on your graphics (with limited exceptions, see <a
        ...
        <div class="zen-resources" id="zen-resources">
          ...
          <ul>
            <li class="view-css">
              ...
              >
                View This Design&#8217;s <abbr title="Cascading Style Sheets"
                  >CSS</abbr
                >
              </a>
            </li>
...
-->
  ...
  <div class="extra3" role="presentation" />
  <div class="extra4" role="presentation" />
  <div class="extra5" role="presentation" />
  <div class="extra6" role="presentation" />
</div>
...
<style>
  ...
  header h1 {
    background: transparent url(http://csszengarden.com/001/h1.gif) no-repeat
      top left;
    margin-top: 10px;
    display: block;
    width: 219px;
  ...
  /* TODO: Extract styling, discuss implications */
  .sidebar {
    margin-left: 600px;
    position: absolute;
    top: 0;
  ...
  .sidebar .wrapper {
    ...
    background: transparent url(http://csszengarden.com/001/paper-bg.jpg) top
      left repeat-y;
    padding: 10px;
    margin-top: 150px;
    width: 130px;
  ...
  .sidebar h3.select {
    background: transparent url(http://csszengarden.com/001/h3.gif) no-repeat
      top left;
    margin: 10px 0 5px 0;
    width: 97px;
    height: 16px;
  ...
  .sidebar h3.archives {
    background: transparent url(http://csszengarden.com/001/h5.gif) no-repeat
      top left;
    margin: 25px 0 5px 0;
    width: 57px;
    height: 14px;
  ...
  .sidebar h3.resources {
    background: transparent url(http://csszengarden.com/001/h6.gif) no-repeat
      top left;
    margin: 25px 0 5px 0;
    width: 63px;
    height: 10px;
  ...
  .sidebar li {
    line-height: 1.3em;
    background: transparent url(http://csszengarden.com/001/cr1.gif) no-repeat
      top center;
    display: block;
    padding-top: 5px;
    margin-bottom: 5px;
