<script>
  ...
  import designs from "./designStore";

  setContext("designs", designs);
</script>

<Slide title="Events and Passing Data" />
  ...
  <div class="page-wrapper">
    <section class="intro" id="zen-intro">
      ...
      <Section class="preamble">
        <svelte:fragment slot="header" let:isHovering={hovering}>
          <h3 class:hovering>The Road to Enlightenment</h3>
          <h4 contenteditable={hovering}>A brief journey</h4>
        </svelte:fragment>
        <p>
    ...
    <div class="main supporting" id="zen-supporting" role="main">
      <Section>
        <h3 slot="header">So What is This About?</h3>
        <p>
      ...
      <Section>
        <h3 slot="header">Participation</h3>
        <p>
